...
export const cards = [
  ...
  export default function analysis () {
    return (
    <>
    <div className='bg-[#d3d3d3] py-[60px] mb-16  '>
      <h1 className="text-[48px]   font-black text-center font-brandon">Featured</h1>
      <p className='text-[17px] text-center my-[17px] font-poppins'>Featured on homepage</p>
      </div>
